					...
					<div class="panel panel-success">
						...
						<div class="panel-body">
							<div class="list-group">
								...
								<a href="?controller=san-pham" class="list-group-item">Sản phẩm</a>
								<a href="?controller=hoa-don" class="list-group-item">Hóa đơn</a>
								<a href="?controller=khach-hang" class="list-group-item">Khách hàng</a>
								<a href="?controller=quan-tri" class="list-group-item">Quản trị viên</a>
								<a href="?controller=tin-tuc" class="list-group-item">Tin tức</a>
								<a href="?controller=banner" class="list-group-item">TBanner slider</a>
							</div>
						</div>
					</div>
				</div>
